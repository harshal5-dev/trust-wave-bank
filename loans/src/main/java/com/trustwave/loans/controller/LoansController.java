...
@Tag(
        name = "CRUD REST APIs for Loans in TrustWave Bank",
        description = "CRUD REST APIs in TrustWave Bank to CREATE, UPDATE, FETCH AND DELETE loan details"
)
@RestController
...
public class LoansController {
  ...
  @Operation(
          ...
          description = "REST API to create new loan inside TrustWave Bank"
  )
  @ApiResponses({
          @ApiResponse(
                  responseCode = "201",
  ...
  @GetMapping("/fetch")
  public ResponseEntity<LoansDto> fetchLoan(@RequestHeader("trustwave-correlation-id") String correlationId,
                                            @RequestParam
                                        @Pattern(regexp="(^$|[0-9]{10})",message = "Mobile number must be 10 digits")
                                      String mobileNumber) {
