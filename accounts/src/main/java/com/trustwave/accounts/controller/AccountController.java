...
import com.trustwave.accounts.dto.ResponseDto;
...
@Tag(name = "CRUD REST APIs for Accounts in TrustWave",
...
public class AccountController {
  ...
  public AccountController(IAccountsService iAccountsService, Environment environment,
  ...
  @Operation(summary = "Create Account REST API",
      description = "REST API to create new Customer &  Account inside TrustWave Bank")
  ...
  @ApiResponses({@ApiResponse(responseCode = "200", description = "HTTP Status OK"),
      @ApiResponse(responseCode = "500", description = "HTTP Status Internal Server Error",
          content = @Content(schema = @Schema(implementation = ErrorResponseDto.class)))})
  @GetMapping("/fetch")
  public ResponseEntity<CustomerDto> fetchCustomer(@RequestParam @Pattern(regexp = "^\\d{10}$",
  ...
  public ResponseEntity<String> getBuildInfo() throws TimeoutException {
    ...
    // throw new TimeoutException("getBuildInfo() method called.");
